  ...
  return (
    <div>
      <div className="bg-hero2 bg-cover bg-center h-[400px]  mt-5 rounded-lg relative flex justify-center items-center">
        ...
        <div className="relative z-20  p-5 flex flex-col items-center shadow">
          <p className="font-bold text-gray-800 text-4xl">
            Welcome to our , self care
          </p>
          <button className="px-6 py-2 mt-5 bg-gray-900 cursor-pointer  text-amber-100 text-base rounded-lg">
            Get started
          </button>
        </div>
      </div>
